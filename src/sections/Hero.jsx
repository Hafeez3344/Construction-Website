...
import backgroundImage from "../../src/assets/homeimg.webp";
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="lg:w-full-[60] w-full flex flex-col justify-center items-start lg:gap-8 gap-4"
      >
        <motion.h1
          variants={slideUpVariants}
        ...
        <p className="text-white text-[20px]">
          ...
          precision. From concept to completion, PrimeStructure is dedicated to
          building your dream space with quality and care.
        </p>
        <motion.div
          initial="hidden"
          whileInView="visible"
